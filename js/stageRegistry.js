...
import { buildElectronicsStore } from './stages/electronics.js';
...
export const STAGE_DEFINITIONS = Object.freeze([
  ...
  },
  {
    ...
    name: '理科室',
    label: 'STAGE 5　理科室',
    clearNote: 'クラシック5ステージ制覇！ そして閉店後の家電量販店に、最後の鬼が待っている。',
  ...
  },
  {
    id: 'electronics',
    name: '家電量販店',
    label: 'STAGE 6　深夜の家電量販店',
    clearNote: '全6ステージ制覇！ 消えた店内放送のあと、カグミンだけが売場に残った。',
    build: buildElectronicsStore,
    startView: {
      position: [-5.8, 0, 4.35],
      yaw: -0.76,
      pitch: 0.46,
